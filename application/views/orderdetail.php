...
<section class="vrprofle">
    <div class="container">
        <div class="col-md-6">
            <div class="pro-log order-detail">
                <div class="im-pro" style="top :10px">
                    <!-- <img src="<?php /*echo base_url(); */?>assets/images/pr-im2.png" alt="">-->
        ...
        <div class="col-md-6">
            <div class="pro-log order-detail">
                <div class="im-pro1" style="top :10px; padding:3px;">
                    ...
                    <div class="col-md-6" style="border-right: #d5d2d2 solid 1px;">
                        <h3><?php echo $booking['event_name']; ?></h3>
                        <div class="small-s"><?php echo date('F j, Y, g:i a', strtotime($booking['created_at'])) ?>
                        </div>
                    </div>
                    <!--<div class="col-md-6"><h3><?php /*echo "Capacity"; */?></h3><div class="small-s"><?php /*echo $booking['total_seats'].' Persons.' */?></div></div>-->
                    <div class="col-md-6">
                        <h3><?php echo $lang['booking_no']; ?></h3>
                        <div class="small-s"><?php echo $booking['booking_no'] ?></div>
                    </div>
                </div>
            ...
            <table id="venues" class="table table-striped table-bordered venues has-venue-table" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class="custom-header"><?php echo $lang['booking_item_no']; ?></th>
                        <th class="custom-header"><?php echo $lang['type']; ?></th>
                        <th class="custom-header"><?php echo $lang['venue_name']; ?></th>
                        <th class="custom-header"><?php echo $lang['event_date']; ?></th>
                        <th class="custom-header"><?php echo $lang['total_seats']; ?></th>
                        <th class="custom-header"><?php echo $lang['price_per_unit']; ?></th>
                        <th class="custom-header"><?php echo $lang['sub_total']; ?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php
