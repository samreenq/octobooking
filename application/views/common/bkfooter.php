      ...
      <div class="modal-body" style="height: 595px;">
		...
		<form action="<?php echo base_url(); ?>loginSubmit" method="POST">
			<center><h3>Login</h3></center>
			  ...
			  <label class="chck">Remember me
                                <input type="checkbox">
                                <span class="checkmark"></span>
                            </label>
                            <a href="javascript:void(0);" class="frgotbtn">Forgot password?</a>
                            <div class="fr-signp">
							    <p>Don't Have an account ?</p>
								<a href="javascript:void(0);" class="frgotbtn">Sign up</a>
							</div>
			  </form>
		  </div>
		  <div style="width:45%;float: right;min-height: 91%;">
